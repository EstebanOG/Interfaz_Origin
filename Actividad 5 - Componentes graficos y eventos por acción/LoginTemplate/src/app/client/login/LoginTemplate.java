...
public class LoginTemplate extends JFrame {
    ...
    public JButton getBRegistrarse(){ return bRegistrarse;}
    
    public JButton getBSignInTemplate(){ return bSignInTemplate;}
    
    public JButton getBCerrar(){ return bCerrar;}
    
    public JButton getBOpcion1(){ return bOpcion1;}
    
    public JButton getBOpcion2(){ return bOpcion2;}
    
    public JButton getBOpcion3(){ return bOpcion3;}
    
    public JTextField getTNombreUsuario(){return tNombreUsuario;}
    
    public JPasswordField getTClaveUsuario(){ return tClaveUsuario;}
    
    public JComboBox getCbRegion(){ return cbRegion;}
    
    public JCheckBox getCheckSi(){ return checkSi;}
